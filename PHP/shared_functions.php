...
function selectquery_bind1($dbpath, $sql, $boundParam) {
 ...
 * Function to generate CSS to style Table output for generateTableFromObjects() call below

 * To use, put the following inside your <style> tag in the head section: <?php generateTableCSS(); ?> 
